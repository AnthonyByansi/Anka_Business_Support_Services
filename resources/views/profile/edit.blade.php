@extends('layouts.app', ['activePage' => 'user', 'title' => 'Anka BUsiness Support services', 'navName' => 'User Profile', 'activeButton' => 'laravel'])
                    ...
                    <div class="col-md-4">
                        <div class="card card-user">
                            ...
                            <div class="card-body">
                                <div class="author">
                                    <a href="#">
                                        <img class="avatar border-gray" src="{{ asset('') }}" alt="...">
